...
#define ImageAttribute_patch_cpp_copyc
#include"duilib_CodePatch/ImageAttribute_patch.h"
#undef ImageAttribute_patch_cpp_copyc
...
#define ImageAttribute_patch_cpp
#include"duilib_CodePatch/ImageAttribute_patch.h"
#undef ImageAttribute_patch_cpp
        else {
